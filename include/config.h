...
// --- OLED Display ---
#define USE_1_3_INCH_OLED   false   // Set to true for 1.3" (SH1106), false for 0.96" (SSD1306)
...
// --- Battery ---
#define ENABLE_BATTERY_MODULE   false   // Set to true if battery & voltage divider are present
...
// --- Touch Input ---
#define TOUCH_DEBOUNCE_MS       50      // Debounce window
...
#define BLINK_INTERVAL_MAX_MS   8000    // Max time between blinks
#define BLINK_DURATION_MS       160     // Total blink duration (close + open)
#define EMOTION_LERP_SPEED      5.0f    // Interpolation speed for transitions
#define TOUCH_REACTION_DURATION 2000    // How long touch reaction lasts (ms)
...
#define OTA_API_URL             "https://api.github.com/repos/" OTA_GITHUB_OWNER "/" OTA_GITHUB_REPO "/releases/latest"
